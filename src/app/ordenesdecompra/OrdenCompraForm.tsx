...
const OrdenCompraForm: React.FC<OrdenCompraFormProps> = ({ onSubmit }) => {
    ...
    return (
        <div className="min-h-screen bg-gray-900 p-8">
            <h2 className="text-3xl font-bold mb-6 text-blue-400">Crear Orden de Compra</h2>
            <form onSubmit={handleSubmit}>
                <div className="mb-4">
                    <label htmlFor="proveedor" className="bg-gray-800 text-gray-200 text-left text-sm font-semibold border-b border-gray-700">Proveedor</label>
                    <input
                        type="text"
                        name="proveedor"
                        id="proveedor"
                ...
                <div className="mb-4">
                    <label htmlFor="fecha_de_creacion" className="bg-gray-800 text-gray-200 text-left text-sm font-semibold border-b border-gray-700">Fecha de Creación</label>
                    <input
                        type="date"
                ...
                <div className="mb-4">
                    <label htmlFor="estado" className="bg-gray-800 text-gray-200 text-left text-sm font-semibold border-b border-gray-700">Estado</label>
                    <select
                        name="estado"
                        id="estado"
                ...
                <div className="mb-4">
                    <label htmlFor="total_compra" className="bg-gray-800 text-gray-200 text-left text-sm font-semibold border-b border-gray-700">Total de la Compra</label>
                    <input
                        type="number"
                        name="total_compra"
                        id="total_compra"
