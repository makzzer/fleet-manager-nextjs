...
import { FiAlertCircle, FiTool, FiTruck } from 'react-icons/fi'
...
export const Card: React.FC<CardProps> = ({ control, handleDragStart }) => {
  ...
  const handleViewDetails = () => {
    router.push(`/control/${control.id}`)
  }
  ...
  return (
    <>
      ...
      >
        ...
        <h3 className="text-lg font-semibold text-white truncate">{control.subject}</h3>
