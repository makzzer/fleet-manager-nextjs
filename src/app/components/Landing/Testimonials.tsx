  ...
  return (
    <section>
      <div className="container mx-auto px-6 sm:px-8">
        <div className="section-heading px-4 sm:px-8 md:px-16">
        <div className="flex justify-center">
          <div className="tag text-lg sm:text-xl md:text-2xl">Experiencias de Éxito</div>
        </div>
        <h2 className="section-title text-2xl sm:text-3xl md:text-4xl font-semibold text-center mt-4">Lo que Dicen Nuestros Clientes</h2>
