      ...
      <div className="container mx-auto px-6 sm:px-8">
        <div className="flex flex-col-reverse md:flex-row items-center">
          <div className="md:w-[600px] text-center md:text-left">
            <div className="tag mb-4 text-sm mt-6 md:text-base">OpenAI</div>
            <div className="tag mb-4 text-sm mt-6 md:text-base">Google Maps</div>
            <div className="tag mb-4 text-sm mt-6 md:text-base">Opsgenie</div>
            <h1 className="text-4xl sm:text-5xl md:text-7xl font-bold tracking-tighter text-white mt-4 md:mt-6">
              Fleet<span className="text-blue-400">Fly</span>
            </h1>
            <p className="section-description text-lg sm:text-xl text-gray-300 mt-5">
              Revolucioná la gestión de tus flotas con tecnología avanzada.
