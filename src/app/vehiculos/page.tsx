...
const Vehiculos = () => {
  ...
  const filterVehiculos = (searchTerm = "") => {
    ...
    !showUnavailable ? filtered = filtered.filter((vehiculo) => vehiculo.status === "AVAILABLE") : 
    filtered = filtered.filter((vehiculo) => vehiculo.status === "UNAVAILABLE" || vehiculo.status === "MAINTENANCE" );
